...
\end{frame}
  ...
  % \begin{frame}
  %   \frametitle{Layers} Spacemacs uses \emph{layers} to structure configuration.
  %   Packages are grouped into layers targeting particular tasks: eg doing
  %   statistics with ESS and interacting with git.
  % \end{frame}
